...
public class SubjectTester {
    ...
    private Vector<Student> mockStudentsRTOS;
    private Vector<Student> mockStudentsBigData;
    ...
    public void setUp() {
        ...
        mockStudentsRTOS = new Vector<Student>();
        mockStudentsBigData = new Vector<Student>();
        ...
        // Add mock students to the mock list for RTOS course
        mockStudentsRTOS.add(student1);
        mockStudentsRTOS.add(student2);
        mockStudentsRTOS.add(student3);
        // Add mock students to the mock list for Big Data course
        mockStudentsBigData.add(student1);
        mockStudentsBigData.add(student2);
        mockStudentsBigData.add(student3);
        mockStudentsBigData.add(student4);
        mockStudentsBigData.add(student5);
    }
    ...
    @Test
    public void testAddAndGetStudents_ShouldContainAddedStudents_subject3() {
        ...
        assertTrue(students.containsAll(mockStudentsRTOS));
    }
    
    
    @Test
    public void testAddAndGetStudents_ShouldContainAddedStudents_subject4() {
        ...
        Vector<Student> students = subject4.GetStudents();
        assertTrue(students.containsAll(mockStudentsBigData));
    }
    
    

    /*** Test cases for check number of students in a specific subject ***/
    @Test
    ...
    @Test
    public void testAddAndGetStudents_ShouldReturnCorrectNumberOfStudentsInRTOSCourse() {
        assertEquals(3, mockStudentsRTOS.size());
    }
    @Test
    public void testAddAndGetStudents_ShouldReturnCorrectNumberOfStudentsInBigDataCourse() {
        assertEquals(5, mockStudentsBigData.size());
    }
    ...
    /*** Test cases for check the students that stored ***/
    @Test
    ...
    @Test
    public void testMockedStudentBehavior_subject3() {
    ...
    @Test
    public void testMockedStudentBehavior_subject4() {
