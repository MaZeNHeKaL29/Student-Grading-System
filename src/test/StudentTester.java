...
public class StudentTester {
    ...
    public void setUp() {
        ...
        student1 = new Student("Mazen Ehab", "1901120s", 20, 30, 15, 25);
      
        student2 = new Student("Andrew Samir", "19002422", 25, 20, 20, 30);

    	student3 = new Student("AbdAllah Mostafa", "1900779s", 25, 15, 15, 25);
    	student4 = new Student("Mostafa Mohamed", "1803093s", 25, 20, 20, 30);
    	student5 = null;
    	student7 = new Student(" Ahmed Mahmoud", "1901143s", 20, 30, 25, 25);
    	student8 = new Student("Mohamed Mostafa", "1901650",20, 25, 25, 25);
    	student9 =  new Student("Mazen Ehab", "1901280s", 20, 20, 25, 25);
    }
    ...
    public void testGetStudentActivitiesMark_student1() {
        Assert.assertEquals(20, student1.GetStudentActivitiesMark());
    }

    @Test
    public void testGetOral_PracticalMark_student1() {
        Assert.assertEquals(30, student1.GetOral_PracticalMark());
    }
    ...
    public void testGetFinalExamMark_student1() {
        Assert.assertEquals(25, student1.GetFinalExamMark());
    }
    ...
    public void testGetStudentActivitiesMark_student2() {
        Assert.assertEquals(25, student2.GetStudentActivitiesMark());
    }

    @Test
    public void testGetOral_PracticalMark_student2() {
        Assert.assertEquals(20, student2.GetOral_PracticalMark());
    }

    @Test
    public void testGetMidtermExamMark_student2() {
        Assert.assertEquals(20, student2.GetMidtermExamMark());
    }

    @Test
    public void testGetFinalExamMark_student2() {
        Assert.assertEquals(30, student2.GetFinalExamMark());
    }

    @Test
    public void testGetTotalMarks_student2() {
        Assert.assertEquals(95, student2.GetTotalMarks());
    }
    ...
    public void testGetStudentActivitiesMark_student3() {
        Assert.assertEquals(25, student3.GetStudentActivitiesMark());
    }

    @Test
    public void testGetOral_PracticalMark_student3() {
        Assert.assertEquals(15, student3.GetOral_PracticalMark());
    }
    ...
    public void testGetFinalExamMark_student3() {
        Assert.assertEquals(25, student3.GetFinalExamMark());
    }

    @Test
    public void testGetTotalMarks_student3() {
        Assert.assertEquals(80, student3.GetTotalMarks());
    }
    	...
    	try (MockedStatic<GPACalculator> studentGradingManager = Mockito.mockStatic(GPACalculator.class))
		 {
			 ...
			 Assert.assertEquals(3.0, student3.GetGPA(), 0.01);
		 }
    ...
    public void testGetStudentActivitiesMark_student4() {
        Assert.assertEquals(25, student4.GetStudentActivitiesMark());
    }

    @Test
    public void testGetOral_PracticalMark_student4() {
        Assert.assertEquals(20, student4.GetOral_PracticalMark());
    }

    @Test
    public void testGetMidtermExamMark_student4() {
        Assert.assertEquals(20, student4.GetMidtermExamMark());
    }

    @Test
    public void testGetFinalExamMark_student4() {
        Assert.assertEquals(30, student4.GetFinalExamMark());
    }

    @Test
    public void testGetTotalMarks_student4() {
        Assert.assertEquals(95, student4.GetTotalMarks());
    }
    @Test
    	...
    	try (MockedStatic<GPACalculator> studentGradingManager = Mockito.mockStatic(GPACalculator.class))
		 {
			 ...
			 Assert.assertEquals(4.0, student4.GetGPA(), 0.01);
		 }
    	...
    	try (MockedStatic<GradeCalculator> studentGradingManager = Mockito.mockStatic(GradeCalculator.class))
		 {
			 ...
			 Assert.assertEquals("A", student4.GetGrade());
		 }
    ...
    public void testGetStudentActivitiesMark_student7() {
        Assert.assertEquals(20, student7.GetStudentActivitiesMark());
    }

    @Test
    public void testGetOral_PracticalMark_student7() {
        Assert.assertEquals(30, student7.GetOral_PracticalMark());
    }

    @Test
    public void testGetMidtermExamMark_student7() {
        Assert.assertEquals(25, student7.GetMidtermExamMark());
    }

    @Test
    public void testGetFinalExamMark_student7() {
        Assert.assertEquals(25, student7.GetFinalExamMark());
    }
    ...
    public void testGetStudentActivitiesMark_student8() {
        Assert.assertEquals(20, student8.GetStudentActivitiesMark());
    }

    @Test
    public void testGetOral_PracticalMark_student8() {
        Assert.assertEquals(25, student8.GetOral_PracticalMark());
    }

    @Test
    public void testGetMidtermExamMark_student8() {
        Assert.assertEquals(25, student8.GetMidtermExamMark());
    }

    @Test
    public void testGetFinalExamMark_student8() {
        Assert.assertEquals(25, student8.GetFinalExamMark());
    }

    @Test
    public void testGetTotalMarks_student8() {
        Assert.assertEquals(95, student8.GetTotalMarks());
    }
